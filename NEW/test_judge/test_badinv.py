...
sys.path.insert(0, os.path.abspath(os.path.dirname(r'NEW\badinv.py')))

def load_module():
    spec = importlib.util.spec_from_file_location("badinv", r"NEW\badinv.py")
