...
sys.path.insert(0, os.path.abspath(os.path.dirname(r'oui\bad1.py')))

def load_module():
    spec = importlib.util.spec_from_file_location("bad1", r"oui\bad1.py")
...
def test_update_x_call_basic():
    ...
    try:
        ...
        pytest.skip("Function 'update_x' requires arguments, skipping basic call")
...
def test_update_data_data_call_basic():
    ...
    try:
        ...
        pytest.skip("Function 'update_data_data' requires arguments, skipping basic call")
    except Exception as e:
...
def test_do_stuff_call_basic():
    ...
    try:
        ...
        pytest.skip("Function 'do_stuff' requires arguments, skipping basic call")
    except Exception as e:
